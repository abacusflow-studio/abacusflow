...
import { TenantInfo, getStoredTenantId, setStoredTenantId, clearTenantContext } from '@abacusflow/core';
...
export function TenantProvider({ children }: { children: React.ReactNode }) {
  const [tenantStatus, setTenantStatus] = useState<TenantContextType['tenantStatus']>('LOADING');
