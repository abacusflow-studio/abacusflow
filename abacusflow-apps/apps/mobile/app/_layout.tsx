  ...
  return (
    <ThemeProvider value={colorScheme === "dark" ? DarkTheme : DefaultTheme}>
      <Stack>
        ...
        <Stack.Screen name="product/edit/[id]" options={{ title: "编辑产品" }} />
        {/* Depot screens */}
        <Stack.Screen name="depot/[id]" options={{ title: "储存点详情" }} />
        <Stack.Screen name="depot/add" options={{ title: "新增储存点" }} />
        <Stack.Screen name="depot/edit/[id]" options={{ title: "编辑储存点" }} />
        {/* Inventory screens */}
        <Stack.Screen name="inventory/[id]" options={{ title: "库存详情" }} />
        {/* Order screens */}
        <Stack.Screen name="order/purchase/[id]" options={{ title: "采购单详情" }} />
        <Stack.Screen name="order/sale/[id]" options={{ title: "销售单详情" }} />
