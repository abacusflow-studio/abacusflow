...
interface TenantMembershipRepository : JpaRepository<TenantMembership, Long> {
    ...
    fun findByTenantIdAndUserId(tenantId: Long, userId: Long): TenantMembership?
    fun findByUserIdAndStatus(userId: Long, status: MembershipStatus): List<TenantMembership>
