...
alter table user_external_identity owner to postgres;
...
alter table purchase_order_item owner to postgres;
...
alter table sale_order_item owner to postgres;
...
alter table depot owner to postgres;
